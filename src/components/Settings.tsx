          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button
              ...
              onClick={async () => {
                ...
                downloadFile(`copilot-sessions-backup-${date}.json`, json, 'application/json');
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                try {
                  ...
                  setBackupMsg(`Restored ${result.imported} sessions (${result.skipped} already cached with equal or more data). Reload to see them.`);
