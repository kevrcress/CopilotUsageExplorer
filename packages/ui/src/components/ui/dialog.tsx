...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-50 grid w-full max-w-3xl max-h-[85vh] translate-x-[-50%] translate-y-[-50%] gap-3 overflow-y-auto border bg-background p-5 shadow-lg sm:rounded-lg',
        className
      )}
      {...props}
    >
