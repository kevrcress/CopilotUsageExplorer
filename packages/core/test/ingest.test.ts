...
import { groupAndParse } from '../src/ingest';
import type { RecoveredFile } from '../src/ingest';
...
/** Plain RecoveredFile literal — no browser File shim needed. */
function fileOf(relPath: string, content: string): RecoveredFile {
...
describe('groupAndParse — subagent child linkage', () => {
